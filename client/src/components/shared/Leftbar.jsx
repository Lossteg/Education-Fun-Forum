          ...
          {communityLinks && communityLinks.length > 0 ? (
            <div className="w-full">
              <div className="flex flex-wrap items-center justify-between">
                <div className="flex gap-1 font-medium items-center md:mb-2 mb-2 md:mb-2">
                  <HiOutlineUserGroup className="text-xl" />
                  Communities
                </div>

                <Link
                  className="md:relative flex relative items-center text-sm font-medium text-primary mr-4 mb-2"
                  to="/my-communities"
                >
                  See all
